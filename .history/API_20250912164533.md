...
### 16. Obtener Estadísticas Generales (cURL)
```bash
...
### 17. Obtener Estadísticas de Usuarios (cURL)
```bash
...
### 18. Obtener Estadísticas de Cursos (cURL)
```bash
curl -X GET http://localhost:8080/api/stats/courses \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json"
```

### 19. Obtener Estadísticas de Inscripciones (cURL)
```bash
curl -X GET http://localhost:8080/api/stats/enrollments \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json"
```

### 20. Obtener Estadísticas de Ingresos (cURL)
```bash
curl -X GET http://localhost:8080/api/stats/revenue \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json"
```

### 21. Obtener Distribución por Categorías (cURL)
```bash
curl -X GET http://localhost:8080/api/stats/categories \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json"
```

### 22. Obtener Estadísticas de Crecimiento (cURL)
```bash
curl -X GET http://localhost:8080/api/stats/growth \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json"
```

### 23. Test de Endpoint de Estadísticas (cURL)
```bash
curl -X GET http://localhost:8080/api/stats/test \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json"
```

### 24. Test de Endpoint Sin Autenticación (cURL)
```bash
curl -X GET http://localhost:8080/api/stats/test-no-auth \
  -H "Content-Type: application/json"
```

### 25. Test de Acceso de Administrador (cURL)
```bash
...
### 26. Test de Endpoint Admin Sin Autenticación (cURL)
```bash
curl -X GET http://localhost:8080/api/admin/test/no-auth \
  -H "Content-Type: application/json"
```
...
- `GET /api/stats/test-no-auth` - Test de endpoint sin autenticación
- `GET /api/admin/test/no-auth` - Test de endpoint admin sin autenticación
...
- `GET /api/stats/courses` - Estadísticas de cursos
- `GET /api/stats/enrollments` - Estadísticas de inscripciones
- `GET /api/stats/revenue` - Estadísticas de ingresos
- `GET /api/stats/categories` - Distribución por categorías
- `GET /api/stats/growth` - Estadísticas de crecimiento
- `GET /api/stats/test` - Test de endpoint de estadísticas
- `GET /api/admin/test` - Test de acceso de administrador
