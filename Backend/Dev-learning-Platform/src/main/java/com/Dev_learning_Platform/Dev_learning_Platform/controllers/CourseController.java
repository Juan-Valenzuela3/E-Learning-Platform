...
public class CourseController {
    ...
    @PreAuthorize("hasRole('ADMIN') or @courseSecurityService.isEnrolled(authentication, #id) or @courseSecurityService.isInstructorOfCourse(authentication, #id)")
    public ResponseEntity<Course> getCourseContent(@PathVariable Long id) {
        Course courseContent = courseService.getCourseContent(id);
