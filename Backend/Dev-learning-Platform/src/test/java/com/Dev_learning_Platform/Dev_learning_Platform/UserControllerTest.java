...
public class UserControllerTest {
    ...
    void registerUser_withUniqueData_shouldReturnOk() throws Exception {
        ...
        mockMvc.perform(post("/api/users/register").contentType("application/json")
                .content(objectMapper.writeValueAsString(dto))).andDo(print())
                .andExpect(status().isOk()).andExpect(jsonPath("$.email").value(dto.getEmail()))
    ...
    void registerUser_withDuplicateEmail_shouldReturnConflict() throws Exception {
        ...
        mockMvc.perform(post("/api/users/register").contentType("application/json")
                .content(objectMapper.writeValueAsString(originalUser))).andExpect(status().isOk());
        ...
        mockMvc.perform(post("/api/users/register").contentType("application/json")
                .content(objectMapper.writeValueAsString(duplicateUser))).andDo(print())
    ...
    void registerUser_withInvalidData_shouldReturnBadRequest() throws Exception {
        ...
        invalidDto
                .setRole(com.Dev_learning_Platform.Dev_learning_Platform.models.User.Role.STUDENT);
